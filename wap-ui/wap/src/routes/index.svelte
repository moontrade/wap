<script>
  ...
  >
	<InfoCard heading="Carbon is Open" icon={PersonFavorite}>
	...
	<InfoCard heading="Carbon is Modular" icon={Application}>
	...
	<InfoCard heading="Carbon is Consistent" icon={Globe}>
